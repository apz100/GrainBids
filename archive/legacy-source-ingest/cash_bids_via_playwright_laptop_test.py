...
# ---------- ROBUST OUTPUT DIR ----------
CANDIDATES = [
    Path(r"P:\Adam\Code\CashGrainBids\output"),
    Path(r"\\DERKS-SERVER\Current\Adam\Code\CashGrainBids\output"),
