...
|---|---|---:|---|---|---|---|
| R-004 | Revenue | P0 | Paid pilot package | One-page scope, onboarding checklist, success metrics, terms, and recurring conversion path | ACTIVE | Use `SERVICE_OFFER.md` and `SALES_DISCOVERY_KIT.md`; draft only, no customer commitment or payment setup |
...
| R-005 | Revenue | First-ten account briefs | Ten evidence-bounded public-information briefs with coverage gaps, proof angles, role maps, discovery questions, offer routing, checklists, and official links in `FIRST_10_ACCOUNT_BRIEFS.md`; no outreach performed |
| R-006 | Revenue | Sales discovery kit | Evidence-bounded 20-minute call guide, qualification scorecard, stop rules, offer routing, data-permission checklist, recap template, and CRM fields documented in `SALES_DISCOVERY_KIT.md`; no outreach or calls performed |
| R-007 | Revenue / product | Farmer beta and B2B sales wave | Farmer beta program, landing copy, feedback template, demo script, elevator/merchandiser one-pager, recruitment drafts, and consent-tracked beta-interest homepage path documented and implemented in draft PR #8; no outreach or deployment performed |
