...
|---|---|---:|---|---|---|---|
| R-006 | Revenue | P0 | Sales discovery kit | Reusable call guide, qualification scorecard, data-permission checklist, and stop/snapshot/pilot routing tied to the first-ten briefs | ACTIVE | Use `FIRST_10_ACCOUNT_BRIEFS.md`; no named contacts, outreach, or customer claims |
